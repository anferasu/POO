...
DROP DATABASE IF EXISTS m1u2h6;

SELECT 'CREATE DATABASE m1u2h6'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'm1u2h6')\gexec
...
CREATE TABLE  pedidos (
  NÚMERO_DE_PEDIDO integer,
  CÓDIGO_CLIENTE varchar(4) DEFAULT NULL,
  ...
  CONSTRAINT FK_pedidos_clientes_CÓDIGO_CLIENTE FOREIGN KEY (CÓDIGO_CLIENTE)
  REFERENCES clientes (CÓDIGO_CLIENTE) ON DELETE CASCADE ON UPDATE CASCADE
)
...
CREATE TABLE productos_pedidos (
  NÚMERO_DE_PEDIDO integer NOT NULL,
  CÓDIGO_ARTÍCULO varchar(4) NOT NULL,
  UNIDADES double precision DEFAULT NULL,
  PRIMARY KEY (NÚMERO_DE_PEDIDO, CÓDIGO_ARTÍCULO),
  CONSTRAINT FK_productos_pedidos_pedidos_NÚMERO_DE_PEDIDO FOREIGN KEY (NÚMERO_DE_PEDIDO)
  REFERENCES pedidos (NÚMERO_DE_PEDIDO) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FK_productos_pedidos_productos_CÓDIGO_ARTÍCULO FOREIGN KEY (CÓDIGO_ARTÍCULO)
  REFERENCES productos (CÓDIGO_ARTÍCULO) ON DELETE CASCADE ON UPDATE CASCADE
)
